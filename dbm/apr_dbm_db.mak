...
!ENDIF 
	...
	-@erase "$(INTDIR)\apr_dbm_db-1.res"
	-@erase "$(INTDIR)\apr_dbm_db_src.idb"
	-@erase "$(INTDIR)\apr_dbm_db_src.pdb"
	-@erase "$(OUTDIR)\apr_dbm_db-1.dll"
	-@erase "$(OUTDIR)\apr_dbm_db-1.exp"
	-@erase "$(OUTDIR)\apr_dbm_db-1.lib"
	-@erase "$(OUTDIR)\apr_dbm_db-1.pdb"
...
"$(INTDIR)\apr_dbm_db-1.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) /l 0x409 /fo"$(INTDIR)\apr_dbm_db-1.res" /i "../include" /i "../../apr/include" /i "\local0\asf\release\build-2.2.15\srclib\apr-util" /d DLL_NAME="apr_dbm_db" /d "NDEBUG" /d "APU_VERSION_ONLY" $(SOURCE)
...
"$(INTDIR)\apr_dbm_db-1.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) /l 0x409 /fo"$(INTDIR)\apr_dbm_db-1.res" /i "../include" /i "../../apr/include" /i "\local0\asf\release\build-2.2.15\srclib\apr-util" /d DLL_NAME="apr_dbm_db" /d "_DEBUG" /d "APU_VERSION_ONLY" $(SOURCE)
