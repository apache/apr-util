...
CLEAN :
!ENDIF 
	-@erase "$(INTDIR)\apr_dbd_oracle-1.res"
	-@erase "$(INTDIR)\apr_dbd_oracle.obj"
	-@erase "$(INTDIR)\apr_dbd_oracle_src.idb"
	-@erase "$(INTDIR)\apr_dbd_oracle_src.pdb"
	-@erase "$(OUTDIR)\apr_dbd_oracle-1.dll"
	-@erase "$(OUTDIR)\apr_dbd_oracle-1.exp"
	-@erase "$(OUTDIR)\apr_dbd_oracle-1.lib"
	-@erase "$(OUTDIR)\apr_dbd_oracle-1.pdb"
...
"$(INTDIR)\apr_dbd_oracle-1.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) /l 0x409 /fo"$(INTDIR)\apr_dbd_oracle-1.res" /i "../include" /i "../../apr/include" /i "\local0\asf\release\build-2.2.15\srclib\apr-util" /d DLL_NAME="apr_dbd_oracle" /d "NDEBUG" /d "APU_VERSION_ONLY" $(SOURCE)
...
"$(INTDIR)\apr_dbd_oracle-1.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) /l 0x409 /fo"$(INTDIR)\apr_dbd_oracle-1.res" /i "../include" /i "../../apr/include" /i "\local0\asf\release\build-2.2.15\srclib\apr-util" /d DLL_NAME="apr_dbd_oracle" /d "_DEBUG" /d "APU_VERSION_ONLY" $(SOURCE)
